...
1. Log into your AWS account and navigate to the Billing and Cost Management service. Choose Cost Explorer from the menu on the left.
   ...
   :alt: AWS Billing and Cost Management left menu with Cost Explorer selected. Described under Calculating your costs with AWS Cost Explorer.
   :align: center
   ```

2. Filter on the billing month.
   ```{image} billing_images/cost-explorer-billing-month.png
   :alt: AWS Cost Explorer date range filter set to July 2025. Described under Calculating your costs with AWS Cost Explorer.
   :align: center
   ```
...
3. You’ll see the unfiltered cost at the top of the report. **This is NOT what you will be billed!**
   ...
   :alt: AWS Cost Explorer unfiltered total of 21675.23 dollars. Described under Calculating your costs with AWS Cost Explorer.
   :align: center
   ```
...
5. Now you’ll see the raw costs for that billing period.
   ...
   :alt: AWS Cost Explorer raw cost total of 22669.03 dollars. Described under Calculating your costs with AWS Cost Explorer.
   :align: center
   ```
...
6. Add a filter to remove AWS Marketplace costs. Set `Billing Entity → Excludes → AWS Marketplace`.
   ...
   :alt: AWS Cost Explorer Billing Entity filter excluding AWS Marketplace. Described under Calculating your costs with AWS Cost Explorer.
   :align: center
   ```
...
19. Repeat this process for each of your accounts. The total across all accounts that use the same PO should match the invoice you receive in the CU Marketplace.
   ```{math}
