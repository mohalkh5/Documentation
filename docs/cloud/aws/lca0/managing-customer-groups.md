...
1. Navigate to the Grouper Group for your AWS Account using one of the following methods:
   ...
   Method 2: Go to the [My Grouper Groups View](https://mygroups.colorado.edu/grouper/grouperUi/app/UiV2Main.index?operation=UiV2MyGroups.myGroups) view in Grouper.
   ...
   ```{image} lca0_images/managing-customer-groups/my-grouper-groups.png
...
2. In the 'Members' tab view, click the "Add members" button.
   ...
   ```{image} lca0_images/managing-customer-groups/add-members-button.png
...
3. In the 'Member name or ID' field, enter the user's [CU IdentiKey](https://oit.colorado.edu/services/identity-access-management/identikey) and select the matching entry.
   ...
   ```{image} lca0_images/managing-customer-groups/enter-identikey.png
...
4. Click the 'Add' button.
   ...
   ```{image} lca0_images/managing-customer-groups/add-user.png
...
5. Verify the new user show up in the table.
   ...
   ```{image} lca0_images/managing-customer-groups/verify-user.png
...
2. In the 'Members' tab view, place a 'check' next to the user(s), and click the 'Remove selected members' button.
   ...
   ```{image} lca0_images/managing-customer-groups/remove-user.png
...
To find your account alias view the top right corner of the screen when logged into the AWS console.
   ```{image} lca0_images/managing-customer-groups/alias.png
...
Refer to [Microsoft Entra Group Add Members Documentation](https://learn.microsoft.com/en-us/entra/fundamentals/how-to-manage-groups#add-members-or-owners-of-a-group) to add members to groups.


### Removing Users
Users can be removed from accessing the AWS account by removing them from the Entra Group.

Refer to [Microsoft Entra Group Remove Members Documentation](https://learn.microsoft.com/en-us/entra/fundamentals/how-to-manage-groups#remove-members-or-owners-of-a-group) to remove members from groups.